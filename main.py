...
if __name__ == "__main__":
    ...
    existing_voter_count = cur.fetchone()[0]
    remaining_voters = 1000 - existing_voter_count

    print(f"Existing voters: {existing_voter_count}")
    print(f"Generating {remaining_voters} new voters...")

    for i in range(remaining_voters):
        ...
        print(f'Produced voter {existing_voter_count + i}, data: {voter_data}')
        producer.flush()
